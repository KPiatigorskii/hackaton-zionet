...
public partial class CompetitionBdTestContext : DbContext
{
	...
	public virtual DbSet<TwitterRecord> TwitterRecords { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity<TwitterRecord>(entity =>
		{
			entity.ToTable("twitter_record");

			entity.Property(e => e.Id).HasColumnName("id");
			entity.Property(e => e.AlreadyFound).HasColumnName("already_found");
			entity.Property(e => e.AuthorId).HasColumnName("author_id");
			entity.Property(e => e.EngineCronUuid).HasColumnName("engine_cron_uuid");
			entity.Property(e => e.EnginePort).HasColumnName("engine_port");
			entity.Property(e => e.EventName)
				.HasMaxLength(50)
				.HasColumnName(" event_name");
			entity.Property(e => e.IsSearching).HasColumnName("is_searching");
			entity.Property(e => e.ParticipantId).HasColumnName(" participant_id");
			entity.Property(e => e.StatusId).HasColumnName("status_id");
			...
			entity.HasOne(d => d.Participant).WithMany(p => p.TwitterRecords)
				.HasForeignKey(d => d.ParticipantId)
				.OnDelete(DeleteBehavior.ClientSetNull)
				.HasConstraintName("FK_twitter_record_user");

			entity.HasOne(d => d.Status).WithMany(p => p.TwitterRecords)
				.HasForeignKey(d => d.StatusId)
				.OnDelete(DeleteBehavior.ClientSetNull)
				.HasConstraintName("FK_twitter_record_status");
		});
