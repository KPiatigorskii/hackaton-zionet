...
{
    public class EventTaskHub<Tmodel, TmodelDTO> : Hub where Tmodel : class, IdModel, new() where TmodelDTO : class, IdModel, new()
    {
        ...
        public EventTaskHub(GenDbController<Tmodel, TmodelDTO> dbController)
        {
