...
{
    public class TaskParticipantHub<Tmodel, TmodelDTO> : Hub where Tmodel : class, IdModel, new() where TmodelDTO : class, IdModel, new()
    {
        private const string GetAllRoles = "admin,manager,participant";
        private const string GetOneRoles = "admin,manager,participant";
        private const string UpdateRoles = "admin,participant";
        private const string CreateRoles = "admin,participant";
        private const string DeleteRoles = "admin,participant";
        private const string ForceDeleteRoles = "admin";


        private readonly GenDbController<Tmodel, TmodelDTO> _dbController;

        public TaskParticipantHub(GenDbController<Tmodel, TmodelDTO> dbController)
        {
